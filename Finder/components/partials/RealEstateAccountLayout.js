  ...
  return (
    <Container className='pt-5 pb-lg-4 mt-5 mb-sm-2'>
      ...
      <Breadcrumb className='mb-4 pt-md-3'>
        ...
        <Breadcrumb.Item linkAs={Link} href='/account-info'>Account</Breadcrumb.Item>
      ...
      <Row>
        ...
        <Col md={5} lg={4} className='pe-xl-4 mb-5'>
          <div className='card card-body border-0 shadow-sm pb-1 me-lg-1'>
            ...
            <Button as={Link} href='/add-property' size='lg' className='w-100 mb-3'>
            ...
            <Collapse in={open} className='d-md-block'>
              ...
              <CardNav className='pt-3'>
                ...
                <CardNav.Item
                  href='/account-blogs'
                  icon='fi-list'
                  active={accountPageTitle === 'Blogs' ? true : false}
                >
                  My Blogs
                </CardNav.Item>
                <CardNav.Item
