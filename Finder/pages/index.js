...
// Log the array of all image URLs to the console
  console.log('allImageUrlsArray:', allImageUrlsArray);
  
  const hrefArray = latestThree.map((property) => property.href);
  const idArray= latestThree.map((property) => property._id);
  const titleArray = latestThree.map((property) => property.title);
  const categoryArray = latestThree.map((property) => property.category);
  const locationArray = latestThree.map((property) => property.location);
  const priceArray = latestThree.map((property) => property.price);
      ...
      <Container as="section" className="pb-4 mb-5">
        <div className="d-flex align-items-end align-items-lg-center justify-content-between mb-4 pb-md-2">
          <div className="d-flex w-100 align-items-center justify-content-between justify-content-lg-start">
            <h2 className="h3 mb-0 me-md-4">Added Recently</h2>
        ...
        <Row className="g-4">
          <Col md={6}>
            <PropertyCardOverlay
              img={{
                src: allImageUrlsArray[0],
                alt: "Background image",
              }}
              href={`/single/${idArray[0]}`}
              title={titleArray[0]}
          ...
          <Col md={6}>
            <PropertyCardOverlay
              img={{
                src: allImageUrlsArray[1],
                alt: "Background image",
              }}
              href={`/single/${idArray[1]}`}
              title={titleArray[1]}
            ...
            <PropertyCardOverlay
              img={{
                src: allImageUrlsArray[2],
                alt: "Background image",
              }}
              href={`/single/${idArray[2]}`}
              title={titleArray[2]}
