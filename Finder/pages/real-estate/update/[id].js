...
const UpdatePropertyPage = () => {
  ...
  const handleSubmit = async () => {
        ...
        router.push('/real-estate/account-blogs')
    }
        ...
        <Row>
          ...
          {/* <Col lg={8}> */}
            ...
            <Breadcrumb className='mb-3 pt-2 pt-lg-3'>
                ...
                <Breadcrumb.Item href='/real-estate'>Home</Breadcrumb.Item>
            ...
            <section className='d-sm-flex justify-content-center pt-2'>
              ...
              <Link href='/real-estate/account-blogs' onSubmit={handleSubmit} passHref>
